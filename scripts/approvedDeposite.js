...
const ABI = require("../artifacts/contracts/mamal.sol/mamal.json");
...
async function main() {
  ...
  const NFT = await ethers.getContractFactory("mamal");
  const nft = await NFT.attach("0x16E20f04864DC4F69940EA6a1a42b781e22DB85D");
